...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher(){
        ...
        employeeID.setBounds(150,220,150,30);
        ...
        course.setBounds(140,500,230,30);
        add(course);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == cancel){
            ...
            String semployeeID = employeeID.getText();
            ...
            try{
                String query = "insert into teacher values('"+sname+"', '"+sfathername+"', '"+semployeeID+"', '"+sdob+"', '"+saddress+"', '"+sphnnumber+"', '"+semail+"', '"+sclassx+"', '"+sclassxii+"', '"+saadharno+"', '"+scourse+"', '"+sbranch+"')";
